...
def generate_launch_description():
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([
            ...
            "description", "mobile_manipulator_pltf.urdf.xacro"
        ]),
        " ",
        "is_sim:=", use_sim_time,
        " ",
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(OnProcessExit(target_action=load_joint_state_broadcaster, on_exit=[load_tricycle_controller])),
        RegisterEventHandler(OnProcessExit(target_action=load_joint_state_broadcaster, on_exit=[load_arm_controller])),
        moveit_launch,
        gazebo,
        rviz,
    ])
